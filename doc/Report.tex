...
\end{figure}\\
Allerdings kann der Punkt $p$ auf dem linken Rand und davon unabhängig der Punkt $q$ auf dem rechten Rand liegen. Davon hängt ab, ob $A$ bzw. $D$ erzeugt werden muss und es hat Einfluss auf die Nachbarschaftsverweise, so dass sich $4$ unterschiedliche Fälle ergeben.\\
